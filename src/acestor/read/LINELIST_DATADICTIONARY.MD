...
| event.symptomOnset.date          | date of symptom onset, based on the ISO 8601 format.        | usually self reported                                                  |
...
| event.test.resultDate            | date of test, compliant with ISO 8601 format.               |                                                                        |
